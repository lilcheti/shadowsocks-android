...
import com.github.yellowvpn.utils.listenForPackageChanges
import com.github.yellowvpn.utils.signaturesCompat
...
object PluginManager {
    class PluginNotFoundException(private val plugin: String) : FileNotFoundException(plugin),
        ...
        override fun getLocalizedMessage() = app.getString(com.github.yellowvpn.core.R.string.plugin_unknown, plugin)
    }
