...
import com.github.yellowvpn.database.Profile
import com.github.yellowvpn.database.ProfileManager
import com.github.yellowvpn.plugin.PluginConfiguration
import com.github.yellowvpn.plugin.fragment.showAllowingStateLoss
import com.github.yellowvpn.preference.DataStore
import com.github.yellowvpn.utils.Action
import com.github.yellowvpn.utils.OpenJson
import com.github.yellowvpn.utils.SaveJson
...
class ProfilesFragment : ToolbarFragment(), Toolbar.OnMenuItemClickListener, SearchView.OnQueryTextListener {
    companion object {
        ...
        private const val KEY_URL = "com.github.yellowvpn.QRCodeDialog.KEY_URL"
    ...
    inner class ProfilesAdapter : RecyclerView.Adapter<ProfileViewHolder>(), ProfileManager.Listener {
        ...
        override fun onRemove(profileId: Long) {
            ...
            if (profileId == DataStore.profileId) DataStore.profileId = 5   // switch to null profile
        }
